...
class B1422_fakeNoPBH(Quad):
    ...
    def __init__(self, sourcemodel_type='NARROW_LINE_Gaussian'):
        ...
        m = [0.859932, 1., 0.424718, 0.035308]
        ...
        super(B1422_fakeNoPBH, self).__init__(zlens, zsource, x, y, m, delta_m, delta_xy, sourcemodel_type, {}, macromodel_type,
