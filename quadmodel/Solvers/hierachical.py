...
class HierarchicalOptimization(BruteOptimization):
    ...
    def optimize(self, data_to_fit, param_class_name, constrain_params, verbose=False):
        ...
        for run in range(0, len(aperture_mass_list_back)):
            ...
            #    substructure_realization=_realization_iteration)
    ...
    # def optimize_old(self, data_to_fit, param_class_name, constrain_params, verbose=False,
