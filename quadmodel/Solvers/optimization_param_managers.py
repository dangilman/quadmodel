from lenstronomy.LensModel.QuadOptimizer.param_manager import PowerLawFixedShear, \
    PowerLawFixedShearMultipole, PowerLawParamManager
from lenstronomy.Util.param_util import shear_cartesian2polar, shear_polar2cartesian
from lenstronomy.Util.param_util import ellipticity2phi_q
import numpy as np

class PowerLawParamManagerUpdatedBounds(PowerLawParamManager):
...
class PowerLawFreeShear(PowerLawParamManagerUpdatedBounds):
...
class PowerLawFreeShearMultipole(PowerLawParamManagerUpdatedBounds):
...
class PowerLawFreeShearMultipole_34(PowerLawParamManagerUpdatedBounds):
